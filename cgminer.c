...
static struct opt_table opt_config_table[] = {
	...
	OPT_WITH_CBARG("--avalon8-voltage",
		     ...
		     "Set Avalon8 default value of core voltage, range:[100, 900], step: 1"),
	...
	OPT_WITH_ARG("--avalon8-freq-sel",
		     ...
		     "Set Avalon8 default frequency select, range:[0, 4], step: 1, example: 2"),
	...
	OPT_WITH_ARG("--avalon8-aucxdelay",
		     ...
		     "Set AUC3 IIC xfer read delay, 4800 ~= 1ms"),
	OPT_WITH_ARG("--avalon8-dsel",
		     opt_set_intval, opt_show_intval, &opt_avalon8_dsel,
		     "Set Avalon8 dsel select, range 0-1. default: 0"),
	OPT_WITH_ARG("--avalon8-core-clk-sel",
		     opt_set_intval, opt_show_intval, &opt_avalon8_core_clk_sel,
		     "Set Avalon8 core clk select, range 0-1. default: 0"),
	...
	OPT_WITH_ARG("--avalon8-mux-l2h",
		     set_int_0_to_255, opt_show_intval, &opt_avalon8_mux_l2h,
		     "Set Avalon8 mux l2h, range 0-2."),
	OPT_WITH_ARG("--avalon8-mux-h2l",
		     set_int_0_to_255, opt_show_intval, &opt_avalon8_mux_h2l,
