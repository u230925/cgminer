...
#define AVA8_DEFAULT_TEMP_MIN		0
#define AVA8_DEFAULT_TEMP_MAX		100
#define AVA8_DEFAULT_TEMP_TARGET	87
#define AVA821_DEFAULT_TEMP_TARGET	87
#define AVA821V_DEFAULT_TEMP_TARGET	81
#define AVA821S_DEFAULT_TEMP_TARGET	69
#define AVA8_DEFAULT_TEMP_OVERHEAT	105

#define AVA8_DEFAULT_VOLTAGE_LEVEL_MIN	0
#define AVA8_DEFAULT_VOLTAGE_LEVEL_MAX	35
...
#define AVA8_DEFAULT_FACTORY_INFO_0_MIN		0
#define AVA8_DEFAULT_FACTORY_INFO_0		0
#define AVA8_DEFAULT_FACTORY_INFO_0_MAX		1
#define AVA8_DEFAULT_FACTORY_INFO_0_CNT		1
#define AVA8_DEFAULT_FACTORY_INFO_0_IGNORE	36

#define AVA8_DEFAULT_FACTORY_INFO_1_CNT		3
#define AVA8_DEFAULT_FACTORY_INFO_2_CNT		4

#define AVA8_DEFAULT_OVERCLOCKING_OFF	0
#define AVA8_DEFAULT_OVERCLOCKING_ON	1

#define AVA8_DEFAULT_FREQUENCY_0M	0
#define AVA8_DEFAULT_FREQUENCY_10M	10
#define AVA8_DEFAULT_FREQUENCY_25M	25
#define AVA8_DEFAULT_FREQUENCY_50M	50
#define AVA8_DEFAULT_FREQUENCY_75M	75
#define AVA8_DEFAULT_FREQUENCY_100M	100
#define AVA8_DEFAULT_FREQUENCY_250M	250
#define AVA8_DEFAULT_FREQUENCY_450M	450
#define AVA8_DEFAULT_FREQUENCY_462M	462
#define AVA8_DEFAULT_FREQUENCY_475M	475
#define AVA8_DEFAULT_FREQUENCY_487M	487
#define AVA8_DEFAULT_FREQUENCY_500M	500
#define AVA8_DEFAULT_FREQUENCY_512M	512
#define AVA8_DEFAULT_FREQUENCY_525M	525
#define AVA8_DEFAULT_FREQUENCY_537M	537
#define AVA8_DEFAULT_FREQUENCY_550M	550
#define AVA8_DEFAULT_FREQUENCY_562M	562
#define AVA8_DEFAULT_FREQUENCY_575M	575
#define AVA8_DEFAULT_FREQUENCY_587M	587
...
#define AVA8_DEFAULT_TH_PASS		10
#define AVA8_DEFAULT_TH_FAIL		1000
#define AVA8_DEFAULT_TH_INIT		32767
#define AVA8_DEFAULT_TH_ADD		0
#define AVA8_DEFAULT_TH_MS		2
#define AVA8_DEFAULT_TH_TIMEOUT		1550000
...
#define AVA8_DEFAULT_ADJUST_VOLT_FREQ	1

#define AVA8_DEFAULT_ADJUST_VOLT_UP_INIT 	20000
#define AVA8_DEFAULT_ADJUST_VOLT_UP_FACTOR 	6
#define AVA8_DEFAULT_ADJUST_VOLT_UP_THRESHOLD 	18300
#define AVA8_DEFAULT_ADJUST_VOLT_DOWN_INIT 	0
#define AVA8_DEFAULT_ADJUST_VOLT_DOWN_FACTOR 	4
#define AVA8_DEFAULT_ADJUST_VOLT_DOWN_THRESHOLD	18656
#define AVA8_DEFAULT_ADJUST_VOLT_TIME 		900

/* A911 adjust frequence parameters */
#define AVA8_DEFAULT_ADJUST_FREQ_UP_INIT 	0
#define AVA8_DEFAULT_ADJUST_FREQ_UP_FACTOR 	4
#define AVA8_DEFAULT_ADJUST_FREQ_UP_THRESHOLD 	5000
#define AVA8_DEFAULT_ADJUST_FREQ_DOWN_INIT 	4000
#define AVA8_DEFAULT_ADJUST_FREQ_DOWN_FACTOR 	6
#define AVA8_DEFAULT_ADJUST_FREQ_DOWN_THRESHOLD	2700
#define AVA8_DEFAULT_ADJUST_FREQ_TIME 		900


#define AVA8_DEFAULT_ASIC_AVERAGE_TEMP_START	12
#define AVA8_DEFAULT_ASIC_AVERAGE_TEMP_END	21
...
#define AVA8_P_SET_ADJUST_VOLT	0x51
#define AVA8_P_SET_ADJUST_FREQ	0x52
...
#define AVA8_DEFAULT_FACTORY_INFO_CNT	(AVA8_DEFAULT_FACTORY_INFO_0_CNT + AVA8_DEFAULT_FACTORY_INFO_1_CNT + AVA8_DEFAULT_FACTORY_INFO_2_CNT)

#define AVA8_DEFAULT_POWER_INFO_CNT	6
...
struct avalon8_info {
	...
	uint16_t get_voltage[AVA8_DEFAULT_MODULARS][1]; /* Output is the same */
	...
	int8_t factory_info[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_FACTORY_INFO_CNT + 1];
	...
	uint16_t power_info[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_POWER_INFO_CNT];
...
extern char *set_avalon8_adjust_volt_info(char *arg);
extern char *set_avalon8_adjust_freq_info(char *arg);
