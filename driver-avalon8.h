...
struct avalon8_info {
	...
	uint32_t core_volt[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX][AVA8_DEFAULT_VOLT_CNT];
	...
	int set_voltage[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];
	...
	uint32_t get_asic[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_CORE_COUNT + 1][2];
	...
	uint16_t current_out[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];
	uint16_t current_top[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];
	uint16_t current_ioa[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];
	uint16_t current_iob[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT];

	uint32_t get_spdlog_pass_sum[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX];
	uint32_t get_spdlog_fail_sum[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX];

	uint32_t get_timer_spdsets[AVA8_DEFAULT_MODULARS][AVA8_DEFAULT_MINER_CNT][AVA8_DEFAULT_ASIC_MAX];
...
extern int opt_avalon8_core_clk_sel;
...
extern uint32_t opt_avalon8_lv1_th_msadd;
extern uint32_t opt_avalon8_lv1_th_ms;
...
extern uint32_t opt_avalon8_h2ltime_spd;
