...
#define AVA8_DEFAULT_TEMP_TARGET	55
...
#define AVA8_DEFAULT_FREQUENCY_20M	20
...
#define AVA8_MM821_VIN_ADC_RATIO	(3.3 / 4095.0 * 19.25 / 5.62 * 1000.0 * 100.0)
...
#define AVA8_MM821_VOUT_ADC_RATIO	(3.3 / 4095.0 * 47.2 / 20.0 * 10000.0 * 100.0)
