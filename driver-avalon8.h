...
#define AVA8_DEFAULT_TEMP_TARGET	67
...
#define AVA8_DEFAULT_FREQUENCY_125M	125
#define AVA8_DEFAULT_FREQUENCY_150M	150
#define AVA8_DEFAULT_FREQUENCY_175M	175
#define AVA8_DEFAULT_FREQUENCY_200M	200
#define AVA8_DEFAULT_FREQUENCY_225M	225
#define AVA8_DEFAULT_FREQUENCY_250M	250
#define AVA8_DEFAULT_FREQUENCY_275M	275
...
#define AVA8_MM852_VIN_ADC_RATIO	(3.3 / 4095.0 * 25.62 / 5.62 * 1000.0 * 100.0)

#define AVA8_MM821_VOUT_ADC_RATIO	(3.3 / 4095.0 * 31.5 / 20.0 * 10000.0 * 100.0)
...
#define AVA8_MM852_VOUT_ADC_RATIO	(3.3 / 4095.0 * 72.3 / 20.0 * 10000.0 * 100.0)
